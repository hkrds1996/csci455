...
public class BookshelfTester{
   ...
   */
   public static void main(String[] args){
      ...
      System.out.println("Calling addFront method arg 1: Expection: [1,2,3,20]");
      myBookShelf2.addFront(1);
      System.out.println(myBookShelf2.toString());
      System.out.println("Calling addLast method arg 100: Expection: [1,2,3,20,100]");
      myBookShelf2.addLast(100);
      System.out.println(myBookShelf2.toString()); 
   }
}