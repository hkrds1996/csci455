...
public class RemoveEvens {
    public static void main(String[] args) {       
       doOneTest(createStack("8"));
       doOneTest(createStack("5"));
       doOneTest(createStack(""));
       doOneTest(createStack("1 2 3 4 5"));
       doOneTest(createStack("1 2 3 4 4 4 5 8"));
    ...
    // before, theStack contains: [1, 2, 3, 4, 5] <-- top
