...
private:
  ...
  ListType *data;        // customer hashtable. when user doesn't give size of data, we denote the size is "HASH_SIZE".
  int entries;           // size of entries, this varible can help us monitor the status of hashtable.
                         // We set it 0 in the constructor;
  int noEmptyBuckets;    // size of noEmptyBuckets, this varible can help us monitor the status of hashtable.
                         // It should be smaller than hashsize.
                         // We set it 0 in the constructor;
  int longestChain;      // the longest chain in our hashtable, this varible can help us monitor the status of hashtable.
                         // It should be smaller than entries.
                         // We set it 0 in the constructor;
